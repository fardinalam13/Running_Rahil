...
public class MapLoader 
{
    ...
    */
    ...
    public TileMap loadMap(String filename)throws IOException
    {
        ...
        player.setX(TileMapDrawer.tilesToPixels(2));
...
//            loadImage("player3.png"),
        ...
        for (int i=0; i<4; i++) 
        {
            playerAnim[i] = createPlayerAnim (images[i][0]);//playerAnim[i] = createPlayerAnim (images[i][0],,images[i][1]);
            flyAnim[i] = createFlyAnim (images[i][1], images[i][1], images[i][2]);
    ...
    public Animation createPlayerAnim(Image player)
    {
