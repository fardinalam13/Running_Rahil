...
public class GameEngine extends GameCore 
{
    ...
    {
                JFrame frame = new JFrame("Running Rahil");
                //frame.setSize(700, 500); 
                frame.setBounds(0, 0, 1240, 720);
		frame.setBackground(Color.black);
//                PopupMenu starter = null;
//                frame.add(starter);
    ...
    public void init()
    {
        ...
        drawer.setBackground(mapLoader.loadImage("background3.jpg"));
    ...
    private void updateCreature(Creature creature,
        ...
        if (tile == null) {
            ...
            if (dy > 0) {
                creature.setY(
                        TileMapDrawer.tilesToPixels(tile.y) - creature.getHeight());
            } else if (dy < 0) {
